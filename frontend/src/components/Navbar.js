    ...
    <>
      <nav>
        <div className="container" style={{ position: "relative" }}>
          ...
          <ul className="nav-ul" style={{ marginLeft: "9rem" }}>
            ...
            <li className="nav-li kateqorya">
              <span onClick={categories} style={{ cursor: "pointer" }}>
                Kateqoriyalar <i className="fas fa-caret-down"></i>
              </span>
          ...
          <ul className="nav-ul" >
              ...
              <li className="nav-li">
                  <a href="https://github.com/iammromar/" target="blank">
                ...
                <li className="nav-li">
                  <a href="https://www.linkedin.com/in/omarbalaqadashov/" target="blank">
                ...
                <li className="nav-li">
                  <a href="https://leetcode.com/iammromar" target="blank">
                  <iconify-icon icon="simple-icons:leetcode" width="30" height="30"></iconify-icon>
                  </a>
                </li>
                <li className="nav-li">
                  <a href="mailto:mromar.work@gmail.com" target="blank">
                  <iconify-icon icon="mdi:gmail" width="30" height="30"></iconify-icon>
                  </a>
                </li>
                <li className="nav-li">
                  <a href="https://wa.me/+994774186033" target="blank">
                  <iconify-icon icon="streamline:whatsapp" width="30" height="30"></iconify-icon>
                  </a>
                </li>
          </ul>
      ...
      <div>
        <div className="mobile-dropdown-category">
          <ul>
            {category.length == 0 ? (
              <p style={{ color: "white" }}>Heç bir Kateqoriya yoxdur</p>
            ) : (
              category.map((i) => (
                <li key={i.id}>
